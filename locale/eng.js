SDL.eng = {
  ...
  view_info_apps_vehicle_ApplicationsStore: 'Apps Store',
  ...
  view_media_cd: 'CD',
  view_media_usb: 'USB',
  view_media_bluetooth: 'BLUETOOTH',
  view_media_lineIn: 'LINE-IN',
  view_media_ipod: 'IPOD',
  view_media_audio_options: 'Audio options',
  view_phone_dial: 'Dial',
  view_phone_end: 'End',
  view_phone_phone: 'Phone',
  view_phone_popUp_callEnded: 'Call Ended',
  view_media_repeat_no: 'Repeat - NO',
  view_media_repeat_all: 'Repeat - ALL',
  view_media_repeat_one: 'Repeat - ONE',
  view_media_shuffle: 'Shuffle',
  view_media_replay: 'Replay',
  view_media_scan: 'Scan',
  view_media_eject: 'Eject',
